...
@Component({
  selector: 'app-editor-followed',
  templateUrl: './editor-followed.component.html',
  styleUrls: ['./editor-followed.component.css']
})
export class EditorFollowedComponent implements OnInit {
  userId = null;
  editors: any = [];
  followed = [];
  editorId = [];
